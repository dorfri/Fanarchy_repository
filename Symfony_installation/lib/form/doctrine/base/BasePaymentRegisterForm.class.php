...
/**
 * PaymentRegister form base class.
 *
 * @method PaymentRegister getObject() Returns the current form's model object
 *
 * @package    PhpProject2
 * @subpackage form
 ...
 */
abstract class BasePaymentRegisterForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ppi_id'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PPI'), 'required' => false)),
      'Siteusers_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Siteusers'), 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('payment_register[%s]');
