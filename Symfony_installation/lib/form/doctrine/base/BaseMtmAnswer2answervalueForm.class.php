...
/**
 * MtmAnswer2answervalue form base class.
 *
 * @method MtmAnswer2answervalue getObject() Returns the current form's model object
 *
 * @package    PhpProject2
 * @subpackage form
 ...
 */
abstract class BaseMtmAnswer2answervalueForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mtm_answer2answervalue[%s]');
